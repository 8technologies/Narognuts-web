...
<head>
  ...
  <title>naro admin | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    {{-- <a href="index3.html" class="brand-link">
      <img src="dist/img/gnut-dp.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Naro G.Nut</span>
    </a> --}}
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Mubiito Edward</a>
        </div>
      </div>
...
{{--          
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="https://adminlte.io">Eignt Tech Consults limited</a>.</strong>
    All rights reserved.
