...
<form method="POST" action="{{ route('multiplierRecords') }}" class="container mt-4">
  ...
  <div class="form-group row">
    <label for="EnterpriseName" class="col-sm-2 col-form-label">Enterprise Name:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group row">
    <label for="DistrictOfOperation" class="col-sm-2 col-form-label">District Of Operation:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group row">
    <label for="SectorOfSpecialisation" class="col-sm-2 col-form-label">Sector Of Specialisation:</label>
    <div class="col-sm-10">
